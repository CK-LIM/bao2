                                                                ...
                                                                <div className="float-right mr-auto">
                                                                    <table>
                                                                        ...
                                                                        <tbody className="textWhiteMedium" style={{ color: 'grey' }}>
                                                                            <tr>
                                                                                <td className="">{this.props.accountLoading ? <div>{this.props.lpTokenBalanceAccount[1][i]}</div> : <div className="center">
                                                                                    <div className="lds-facebook"><div></div><div></div><div></div></div></div>}</td>
                                                                                <td className="">{this.props.accountLoading ? <div>{parseFloat(this.props.userSegmentInfo[1][i])}</div> : <div className="center">
                                                                                    <div className="lds-facebook"><div></div><div></div><div></div></div></div>} </td>
                                                                                <td className="">{this.props.aprloading ? <div>{parseFloat(this.props.apr[1][i]).toFixed(3)}% &nbsp;</div> : <div className="center">
                                                                                    <div className="lds-facebook"><div></div><div></div><div></div></div></div>} </td>
                                                                                <td className="">%  </td>
                                                                                <td className="">$ {this.props.tvl[1][i]} </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
