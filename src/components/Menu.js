                                                                ...
                                                                <div className="float-right mr-auto">
                                                                    <table>
                                                                        ...
                                                                        <tbody className="textWhiteMedium" style={{ color: 'grey' }}>
                                                                            <tr>
                                                                                <td className="">{this.props.accountLoading ? <div>{parseFloat(this.props.lpTokenBalanceAccount[0][i]).toLocaleString('en-US', { maximumFractionDigits: 3 })}</div> : <div className="center">
