...
class Navb extends Component {
  render() {
    return (
      <Navbar style={{topmargin:"0", padding: "0" }}>
        <Nav>
          <MediaQuery maxWidth={900}  >
            <Menu>
              ...
              <div className='dropdown'><NavLink className='dropdown' to='/synthetic/' activeStyle={{ fontWeight: "bold", color: "#ffae00" }}>Synthetic</NavLink></div>
            </Menu>
          </MediaQuery>
          ...
          <MediaQuery minWidth={351}>
            <NavLink className="topleft1 textMiddleBold1 reallyBold" to="/"><b>BAKLAVA.SPACE</b></NavLink>
          </MediaQuery>
          <MediaQuery minWidth={280} maxWidth={350}>
            <NavLink className="topleft1 textMiddleBold1 reallyBold" to="/"><b>BAKLAVA</b></NavLink>
          </MediaQuery>
