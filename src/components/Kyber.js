                        ...
                        <div className="mb-4">
                            ...
                            <div className="left">
                                ...
                                <MediaQuery maxWidth={400}>
                                    ...
                                    <Buttons style={{ color: "#ff9a04", fontSize: "0.8rem", border: "1px solid #ff9a04" }} variant="link" size="sm" as={Link} to="/menu/v2/kyber">KYBERSWAP</Buttons>
                                    <Buttons style={{ color: "#ff9a04", fontSize: "0.8rem" }} variant="link" size="sm" as={Link} to="/menu/v2/traderjoe">TRADER JOE</Buttons>
                                </MediaQuery>
                            </div>
                        </div>
                    </MediaQuery>
