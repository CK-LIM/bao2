                            ...
                            <table style={{ width: "900px" }}>
                                <thead className="textBlackSmall" style={{ color: 'black' }}>
                                    <tr>
                                        ...
                                        <th scope="col" width="120" style={{ border: '0px' }}>BAVA Balance<div className='mt-3'>{(this.props.wallet || this.props.walletConnect) && this.props.accountLoading ? <div>{parseFloat(window.web3Ava.utils.fromWei(this.props.bavaTokenBalance, 'Ether')).toLocaleString('en-US', { maximumFractionDigits: 5 })} BAVA / $ {(window.web3Ava.utils.fromWei(this.props.bavaTokenBalance, 'Ether') * this.props.BAVAPrice).toLocaleString('en-US', { maximumFractionDigits: 0 })}</div> : <div className="center">
                                            <div className="lds-facebook mt-3"><div></div><div></div><div></div></div></div>}</div></th>
                                        <th scope="col" width="120" style={{ border: '0px' }}>Staked BAVA<div className='mt-3'>{(this.props.wallet || this.props.walletConnect) && this.props.accountLoading ? <div>{parseFloat(window.web3Ava.utils.fromWei(this.props.stakeAmount, 'Ether')).toLocaleString('en-US', { maximumFractionDigits: 5 })} BAVA / $ {(window.web3Ava.utils.fromWei(this.props.stakeAmount, 'Ether') * this.props.BAVAPrice).toLocaleString('en-US', { maximumFractionDigits: 0 })}</div> : <div className="center">
                                            <div className="lds-facebook mt-3"><div></div><div></div><div></div></div></div>}</div></th>
                                        <th scope="col" width="120" style={{ border: '0px' }}>Unclaimed Reward<div className='mt-3'>{(this.props.wallet || this.props.walletConnect) && this.props.accountLoading ? <div>{parseFloat(window.web3Ava.utils.fromWei(this.props.earnedAmount, 'Ether')).toLocaleString('en-US', { maximumFractionDigits: 5 })} BAVA / $ {(window.web3Ava.utils.fromWei(this.props.earnedAmount, 'Ether') * this.props.BAVAPrice).toLocaleString('en-US', { maximumFractionDigits: 0 })}</div> : <div className="center">
                                            <div className="lds-facebook mt-3"><div></div><div></div><div></div></div></div>}</div></th>
                                    </tr>
                                </thead>
                            </table>
                        ...
                        <div className="center ">
                            <table style={{ width: "900px" }}>
                                <thead className="textBlackSmall" style={{ color: 'black' }}>
                                    <tr>
                                        <th scope="col" width="100" style={{ border: '0px' }}><img src={logo} width="50" height="50" alt="" /></th>
                                        <th scope="col" width="120" style={{ border: '0px' }}>Total BAVA Staked<div className='mt-3'><div>{parseFloat(window.web3Ava.utils.fromWei(this.props.totalStake, 'Ether')).toLocaleString('en-US', { maximumFractionDigits: 5 })} BAVA / $ {(window.web3Ava.utils.fromWei(this.props.totalStake, 'Ether') * this.props.BAVAPrice).toLocaleString('en-US', { maximumFractionDigits: 0 })}</div></div></th>
                        ...
                        {this.props.wallet || this.props.walletConnect ?
                            ...
                            <div className="card-body">
                                <div className="center">
                                    ...
                                    }}>Connect to display</Buttons></div>
                            </div>
                        }
                    </div>
                </div>
